<?php
if(isset($_GET['notequal'])==true)
{echo '<script>alert("Password and Confirm not match");</script>';}
if(isset($_GET['email'])==true)
{echo '<script>alert("Email error or Email already used");</script>';}
if(isset($_GET['complete'])==true)
{echo '<script>alert("Please enter all fileds");</script>';}
if(isset($_GET['cc'])==true)
...
if($Fname&&$Lname&&$Email&&$Username&&$Password&&$again_password)
 {
	 header("location:student.php?cc=1");

	 if($Password==$again_password)
	 {
		 		  header("location:student.php?notequal=1");
 $connect = mysql_connect('localhost','root','') or die('Error');
mysql_select_db('exam');
$sql = mysql_query("INSERT INTO student VALUES('$Fname','$Lname','$Email','$Username','$Password','$again_password')")
 or die ('Error');
	  
          header("location:student.php?complete=1");
		  header("location:student.php?email=1");
 }
 }
 }
...
<head>
  ...
  <title> Student Subscribe - Web site For Online Exam </title>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item active" href="student.php"><i class="fas fa-user-graduate"></i> Subscribe Student</a>
          </li>
    ...
    <div id="subscribe-form" class="wow fadeIn animated animated" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeIn;">
      <div class="row">
        <div class="col-md-5 offset-md-4">
          <form class="subscribe" method="POST" action="student.php">
