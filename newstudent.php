...
if($Fname&&$Lname&&$Email&&$Username&&$Password&&$again_password)
 {
	 header("location:newstudent.php?cc=1");
...
$sql = mysql_query("INSERT INTO student VALUES('$Fname','$Lname','$Email','$Username','$Password','$again_password')")
 or die ('Error');
		  ...
		  header("location:newstudent.php?notequal=1");
          header("location:newstudent.php?complete=1");
 }
 }
 }
...
<html>
<head>
<title>Web site For Online Exam Student Subscribe </title>
     ...
     <div id="subscribe-form" class="wow fadeIn animated animated" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeIn;">
      <div class="row">
        <div class="col-md-5 offset-md-4">
          <form class="subscribe" method="POST" action="newstudent.php">
            ...
            <button type="submit" class="btn btn-primary" id="btn" value="Subscribe">
