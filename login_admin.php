...
if($_POST)
{
	...
	if(mysqli_num_rows($result)==1)
	{
		...
		header("location:add_teacher.php?error=1"); }
...
<html>
<head>
<title> Login In admain Web site for Online Exam </title>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item active" href="login_admin.php"><i class="fas fa-user"></i> admin Login</a>
...
<div class="col-md-4 offset-md-4">
    <form class="form-s" method="POST">
        ...
        <button type="submit" class="btn btn-primary" id="btn" value="Login" onclick ="window.location.href='add_teacher.php'"> <i class="fas fa-paper-plane"></i> Login</button>
      </form>
</div>
</div>
</div>
